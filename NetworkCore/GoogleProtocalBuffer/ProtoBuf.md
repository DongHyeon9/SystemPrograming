...
프로토버프 컴파일러가 필요 (protoc는 프로토 컴파일러 약자)

링크 : https://github.com/protocolbuffers/protobuf/releases/tag/v34.1

프로토버프는 버전에 따라 문법이 다름(기재된 링크는 3버전)

프로토버프3 문서 : https://protobuf.dev/programming-guides/proto3/
