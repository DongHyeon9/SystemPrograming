...
bool Client_Overlapped_Event::Initialize()
{
	std::cout << "Initialize Client Overlapped Event" << std::endl;
...
void Client_Overlapped_Event::Deinitialize()
{
	::closesocket(socket);
	__super::Deinitialize();
}

void Client_Overlapped_Event::Run()
{
